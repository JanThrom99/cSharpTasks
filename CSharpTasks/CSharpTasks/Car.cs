...
namespace CSharpTasks
{
    public class Car : Vehicle
    {
        ...
        public Car(int typeId, string make, string model, int cCM, string color, int tyres)
        {
            TypeId = typeId;
            Make = make;
            Model = model;
        ...
        public void PrintCarInformation()
        {
            Console.WriteLine($"Mein Fahrzeug ist ein " +
                              $"{Make} {Model} mit einem Hubraum von " +
        ...
        public static Car AskUserForCar()
        {
            ...
            Console.WriteLine("Gebe mir den Modelnamen");
